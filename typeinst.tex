...
%
\author{Paul Strohmeier\inst{1}
\and Cedric Honnet\inst{2}
\and Samppa von Cyborg\inst{3}}
%
...
\institute{
  ...
  \email{paul.strohmeier@gmail.com}\\
  \and
  Carpe Noctem Labs, 
  \email{cedric@carpenoctem.cc}\\
  \and
  Von Cyborg Bodyart, 
  \email{sampp@voncyb.org}
}
...
\bibitem{Holz} Holz, C., Grossman, T., Fitzmaurice, G., Agur A.: Implanted user interfaces. Proceedings of the 2012 ACM annual conference on Human Factors in Computing Systems (2012)

\bibitem{Hameed} Hameed, J., Harrison, I., Gasson, M.N., Warwick, K.: A novel human-machine interface using subdermal magnetic implants. 2010 IEEE 9th International Conference on Cyberntic Intelligent Systems (2010)

\bibitem{Motherboard} The Half Life of Body Hacking | Motherboard.\\ http://motherboard.vice.com/read/the-half-life-of-body-hacking.\\ Accessed 20 Mar 2016

\bibitem{Heffernan} Heffernan, K.J., Vetere, F.: You Put What, Where ? Hobbyist Use of Insertable Devices. Proceedings of the 2016 ACM annual conference on Human Factors in Computing Systems (2016)

\bibitem{PingBody} Ping Body - Institute for the Unstable Media. http://v2.nl/events/ping-body. Accessed 21 Oct 2015

\bibitem{Warwick} Warwick, K., Ruiz V On: linking human and machine brains. Neurocomputing (2008)

\bibitem{Graafstra} Graafstra, A.: Hands On: How radio-frequency identifion and I got personal. IEEE Spectrum 18 23 (2007)
